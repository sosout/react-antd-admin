...
import { getUserPagedList, delUser, delUsers, saveUser } from "api";
  ...
  columns = [
...

    {
      ...
      render: (text, record) => {
        return (
          <div>
            <a href="javascript:;" onClick={() => this.editUser(record)}>
              编辑
            </a>
    ...
    return (
      <div>
        ...
        <div style={{ marginBottom: 16 }}>
          <Button type="primary" icon="plus-square-o" onClick={this.addUser}>
            新增
          </Button>
          <Divider type="vertical" />
