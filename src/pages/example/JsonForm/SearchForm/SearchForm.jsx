    ...
    return (
      <div>
        <div>
          ...
          <TextArea
            rows={15}
            defaultValue={JSON.stringify(this.state.searchSchema, null, 4)}
            onChange={this.searchSchemaChange}
          />
        </div>
        <div style={{ marginTop: 10 }}>
          ...
          <TextArea
            rows={15}
            defaultValue={JSON.stringify(this.state.searchUiSchema, null, 4)}
            onChange={this.searchUiSchemaChange}
          />
        </div>
        <div style={{ marginTop: 10 }}>
          <Button type="primary" onClick={this.parseSchema}>
            重新解析
          </Button>
        </div>
        ...
        <SearchForm
          noCacheSchema={true}
          schema={this.state.searchSchema}
          uiSchema={this.state.searchUiSchema}
